            ...
            <div className="relative space-y-5 pl-5 before:absolute before:bottom-3 before:left-[0.85rem] before:top-3 before:w-px before:bg-[#2FA084]/22">
              ...
              return (
                <article key={`${item.kind}-${item.title}-${index}`} className="relative">
                  <span className="absolute -left-[1.58rem] top-6 grid h-9 w-9 place-items-center rounded-md bg-[#2FA084] text-white shadow-[0_0_0_6px_rgba(111,207,151,0.2)]">
                    <Icon />
                  </span>
                  <div className="premium-card rounded-md p-6">
                    ...
                    <h3 className="mt-4 text-2xl font-black text-[#1F6F5F] light:text-slate-950">{item.title}</h3>
